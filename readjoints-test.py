...
animation_params = support_test.AnimationParameters(t_final=5)    
t = numpy.r_[animation_params.t_initial:animation_params.t_final:animation_params.t_step]

x,details=scipy.integrate.odeint(func1,ini,t,rtol=1e-5,atol=1e-5,hmin=1e-14,full_output=True)#use without Baumgartes
