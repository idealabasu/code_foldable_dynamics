...
ini = [0.0001, 0, 0.0, 0.000, 0.001, 0, 0, 0]#newmechanism.cad.joints
...
# #these settings work best for 4 bar mechanism  (newMechanism.cad.joints)    
        ...
        new_rigid_body.vector_from_fixed((3,2,1)).dot(N.z) - unused_child.vector_from_fixed((3,2,1)).dot(N.z),
#==============================================================================
#these settings work for both 5 bar and 4 bar mechanisms mentioned above, tolerance should be e^-8 for 5 bar to solve       
#    c1,
#    c2,
#    c3,
#    c4,
...
#ini = [x1[0,-1], x1[1,-1], x1[2,-1], x1[3,-1], x1[4,-1], x1[5,-1], x1[6,-1], x1[7,-1]]
#eq1 = [
#       c1,
#    c2,
##    c3,
...
csv.write('output1.csv',numpy.c_[t1,x1])
plt.plot(cy)
#increment = ini[0]/10
#sum = increment
